const data = [
	...
	},
	{
		...
		description:
			' guitar class to be branded and demos to be conducted for enrolment of children on white hat junior ',
	...
	},
	{
		...
		description:
			'Integrating  Aashirvaad Atta into the tiffin boxes of all students on their return to school post their  summer vacations.',
	...
	},
	{
		...
		description:
			'Camlin WhiteBoard Markers have brighter inks for better visibility. They are refillable, easily erasable and have a bullet tip. The ink is non-toxic and is available in four colours.',
		objective:
			'Camlin WhiteBoard Markers have brighter inks for better visibility. They are refillable, easily erasable and have a bullet tip. The ink is non-toxic and is available in four colours.',
	...
	},
	{
		...
		name: 'trial campaign',
		description:
			'Use ‘any-name-of-your-choice’@YOPmail.com to sign up anywhere. Email sent to the ‘address’@YOPmail.com is instantaneously created at YOPmail server. No registration required for checking your temporary inbox at YOPmail',
		objective: 'test,test',
	...
	},
	{
		...
		description:
			'The Lorem ipum filling text is used by graphic designers, programmers and printers with the aim of occupying the spaces of a website, an advertising product or an editorial production whose',
		objective: 'test',
